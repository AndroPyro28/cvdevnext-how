...
export default function ViewProperty({userId}) {
    ...
    useEffect(() => {
        const fetchPropertyDetails = async () => {
            setLoading(true)
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/home-owner/properties-by-propId/${propId}`);
